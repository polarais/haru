          ...
          <div className="p-8 text-center">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className={`${cancelText ? 'flex-1' : 'w-full'} px-6 py-3 ${typeStyles.confirmBg} text-white rounded-2xl transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] shadow-sm`}
              >
                {confirmText}
              </button>
            </div>
