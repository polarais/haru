...
| SC-AUTH-06 | 비밀번호 재설정 | 비밀번호 재설정 요청 | /reset-password |
...
| 로그인 화면 | 비밀번호 재설정 | 재설정 화면 | - |
| 캘린더 뷰 | 날짜 클릭 | 일기 작성 페이지 | 해당 날짜 일기 없음 |
| 캘린더 뷰 | 날짜 클릭 | 일기 패널 열기 | 해당 날짜 일기 있음 |
| 캘린더/타임라인 | + 버튼 클릭 | 일기 작성 페이지 | 오늘 일기 3개 미만 |
| 캘린더/타임라인 | + 버튼 클릭 | 내일 작성 확인 | 오늘 일기 3개 |
| 타임라인 뷰 | 일기 클릭 | 일기 패널 열기 | - |
| 일기 작성 페이지 | 모드 전환 | Journal ↔ AI Chat | 작성 중 전환 가능 |
| Journal 모드 | 저장 | 메인 화면 | 일반 저장 |
| Journal 모드 | AI와 대화 | AI와 대화 페이지 | 저장 전 AI 대화 |
| AI Chat 모드 | 저장 | AI 요약 생성 → 저장 | 자동으로 AI 요약 생성 후 저장 |
| 일기 패널 | 수정 | 수정 페이지 | Edit 모드로 전환 |
| 일기 패널 | 삭제 | 삭제 확인 | - |
| 일기 패널 | 전체화면 | 전체화면 보기 | 데스크톱만 |
| 일기 패널 | 이전/다음 | 일기 패널 | 다른 일기로 이동 |
| 삭제 확인 | 확인 | 메인 화면 | 일기 삭제 후 |
| 삭제 확인 | 취소 | 일기 패널 | - |
| 수정 페이지 | 저장 | 일기 패널 | 수정 내용 반영 |
| 수정 페이지 | 취소 | 일기 패널 | - |
| 전체화면 보기 | 수정 | 수정 페이지 | - |
| 전체화면 보기 | 삭제 | 삭제 확인 | - |
| 전체화면 보기 | 닫기 | 일기 패널 | - |
| AI와 대화 | 대화 포함 저장 | 메인 화면 | 일기와 AI 대화 내용 함께 저장 |
| AI와 대화 | 닫기 | 메인 화면 | AI 대화 없이 복귀 |
