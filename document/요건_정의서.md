...
| 기능 ID | 기능명 | 설명 | 우선순위 |
|---------|--------|------|----------|
| WRITE-01 | 일기 작성 | 제목, 내용, 기분 이모지 선택하여 일기 작성 | 필수 |
| WRITE-02 | AI 대화모드 | AI와 대화하며 일기 내용 구성 | 필수 |
| WRITE-03 | 사진 첨부 | 일기에 여러 장의 사진 첨부 | 필수 |
| WRITE-04 | 임시 저장 | 작성 중인 일기 임시 저장 | 선택 |
...
| VIEW-03 | 일기 상세보기 | 개별 일기 전체 내용 조회 (동일 날짜 일기간 네비게이션 포함) | 필수 |
...
| 기능 ID | 기능명 | 설명 | 우선순위 |
|---------|--------|------|----------|
| AI-01 | AI 성찰 | 작성된 일기에 대한 AI 분석 및 요약 | 필수 |
| AI-02 | AI 대화 | AI와 대화를 통한 심층 성찰 | 필수 |
| AI-03 | AI 질문 생성 | 맞춤형 성찰 질문 제공 | 필수 |
| AI-04 | 감정 패턴 분석 | 장기간 감정 변화 분석 | 선택 |

### 1.5 일기 관리 기능
| 기능 ID | 기능명 | 설명 | 우선순위 |
|---------|--------|------|----------|
| MANAGE-01 | 일기 수정 | 작성된 일기 수정 | 필수 |
| MANAGE-02 | 일기 삭제 | 작성된 일기 삭제 | 필수 |
| MANAGE-03 | 일기 내보내기 | PDF/텍스트로 내보내기 | 선택 |
...
| SC-AUTH-03 | 비밀번호 재설정 | 비밀번호 재설정 요청 | /reset-password |
...
| 화면 ID | 화면명 | 설명 | 
|---------|--------|------|
| SC-MODAL-01 | 삭제 확인 | 일기 삭제 확인 다이얼로그 |
| SC-MODAL-02 | 사진 업로드 | 사진 선택 및 업로드 |
...
| 시작 화면 | 액션 | 도착 화면 | 조건 |
|-----------|------|-----------|------|
| 로그인 | 로그인 성공 | 캘린더 뷰 | 인증 성공 |
| 캘린더 뷰 | 날짜 클릭 | 일기 작성 | 해당 날짜 일기 없음 |
| 캘린더 뷰 | 날짜 클릭 | 일기 상세 | 해당 날짜 일기 1개 이상 (첫번째 표시) |
| 캘린더 뷰 | + 버튼 클릭 | 일기 작성 | 오늘 일기 3개 미만 |
| 일기 작성 | 저장 | 캘린더 뷰 | 일반 저장 |
| 일기 작성 | AI 성찰 | AI 성찰 화면 | 성찰 요청 |
| 일기 상세 | 이전/다음 버튼 | 일기 상세 | 동일 날짜 다른 일기로 이동 |
| 일기 상세 | 전체화면 | 일기 전체화면 | 데스크톱만 |
| 일기 상세 | AI 성찰 | AI 성찰 화면 | - |
| AI 성찰 | 저장 | 일기 상세 | 성찰 저장 |
